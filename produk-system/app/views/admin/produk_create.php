...
<div class="container">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="index.php?controller=produk&action=index" class="btn-back">
        ...
        <div class="card-body">
            ...
            <!-- Form -->
            <form action="index.php?controller=produk&action=store" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="deskripsi" class="form-control" placeholder="Deskripsikan produk..."></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <small class="text-muted">Format: JPG, PNG, JPEG. Kosongkan jika tidak ada gambar.</small>
                </div>
